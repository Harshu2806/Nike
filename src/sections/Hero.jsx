  ...
  return (
    ...
    gap-10 max-container">
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center item-start w-full max-xl:padding-x pt-28">
        ...
        <p className="mt-5 font-montserrat mb-14 text-slate-gray text-lg leading-8 sm:max-w-sm">
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen
       max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img 
        src={bigShoeImg} alt="Shoe" width={610} height={500}
        className="object-content relative z-10" />

        <div className="flex sm:gap-6 gap-4 absolute -bottom-[9%]
        left-[10%] max-sm:px-6">
          {shoes.map((shoe) => (
            <div key={shoe}>
                <ShoeCard 
